	...
	<div class="check-div form-inline row">
        ...
        <div class="col-xs-11">
            <form method="get" action="{:url('index')}" id="searchForm">
                <div class="col-xs-7">
                        <select name="cate" style="color:inherit">
                            <option value="">--资讯分类--</option>

                                <option value="1" {eq name="Think.get.cate" value="1"
                                        }selected{/eq}>媒体报道</option>
                            <option value="2" {eq name="Think.get.cate" value="2"
                                    }selected{/eq}>行业资讯</option>
                            <option value="3" {eq name="Think.get.cate" value="3"
                                    }selected{/eq}>企业动态</option>
                        </select>
